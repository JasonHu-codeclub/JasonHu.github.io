...
const HeaderCenter = tw.div`mx-auto flex px-8  h-full max-w-screen-lg items-center text-slate-500 font-semibold `;
...
const NavItem = styled.a`
  ${navItemStyle}
`;
const Footer = tw.footer`w-full absolute left-0 bottom-5 space-x-2 text-center text-sm text-slate-300`;
